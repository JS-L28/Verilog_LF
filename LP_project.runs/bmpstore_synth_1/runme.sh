...
HD_PWD='C:/Users/opq20/LP_project/LP_project.runs/bmpstore_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bmpstore.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bmpstore.tcl
