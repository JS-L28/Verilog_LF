...
HD_PWD='C:/Users/opq20/LP_project/LP_project.runs/IPaddr_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IPaddr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IPaddr.tcl
