...
#
# Script generated by Vivado on Wed Mar 27 18:36:43 +0900 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : bmpstore.sh
...
#
# Usage        : bmpstore.sh
#                bmpstore.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                bmpstore.sh [-reset_run]
#                bmpstore.sh [-reset_log]
#                bmpstore.sh [-help]
#
...
# script info
echo -e "bmpstore.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./bmpstore.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot bmpstore xil_defaultlib.bmpstore xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim bmpstore -key {Behavioral:sim_1:Functional:bmpstore} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb bmpstore.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./bmpstore.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: bmpstore.sh [-help]\n\
Usage: bmpstore.sh [-step]\n\
Usage: bmpstore.sh [-lib_map_path]\n\
Usage: bmpstore.sh [-reset_run]\n\
Usage: bmpstore.sh [-reset_log]\n\
Usage: bmpstore.sh [-keep_index]\n\
Usage: bmpstore.sh [-noclean_files]\n\n\
