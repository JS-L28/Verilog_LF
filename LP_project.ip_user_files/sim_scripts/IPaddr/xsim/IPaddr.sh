...
#
# Script generated by Vivado on Wed Mar 27 18:36:27 +0900 2024
...
#
# Usage        : IPaddr.sh
#                IPaddr.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                IPaddr.sh [-reset_run]
#                IPaddr.sh [-reset_log]
#                IPaddr.sh [-help]
#
...
# script info
echo -e "IPaddr.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./IPaddr.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot IPaddr xil_defaultlib.IPaddr xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim IPaddr -key {Behavioral:sim_1:Functional:IPaddr} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb IPaddr.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./IPaddr.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: IPaddr.sh [-help]\n\
Usage: IPaddr.sh [-step]\n\
Usage: IPaddr.sh [-lib_map_path]\n\
Usage: IPaddr.sh [-reset_run]\n\
Usage: IPaddr.sh [-reset_log]\n\
Usage: IPaddr.sh [-keep_index]\n\
Usage: IPaddr.sh [-noclean_files]\n\n\
