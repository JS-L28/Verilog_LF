...
#
# Script generated by Vivado on Mon Jan 08 15:07:12 +0900 2024
# SW Build 3865809 on Sun May  7 15:05:29 MDT 2023
#
# Tool Version Limit: 2023.05 
#
# Filename     : hashtable.sh
...
#
# Usage        : hashtable.sh
#                hashtable.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                hashtable.sh [-reset_run]
#                hashtable.sh [-reset_log]
#                hashtable.sh [-help]
#
...
# script info
echo -e "hashtable.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./hashtable.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L blk_mem_gen_v8_4_6 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot hashtable xil_defaultlib.hashtable xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim hashtable -key {Behavioral:sim_1:Functional:hashtable} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb hashtable.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./hashtable.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: hashtable.sh [-help]\n\
Usage: hashtable.sh [-step]\n\
Usage: hashtable.sh [-lib_map_path]\n\
Usage: hashtable.sh [-reset_run]\n\
Usage: hashtable.sh [-reset_log]\n\
Usage: hashtable.sh [-keep_index]\n\
Usage: hashtable.sh [-noclean_files]\n\n\
